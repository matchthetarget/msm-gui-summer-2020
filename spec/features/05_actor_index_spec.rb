...
describe "/actors" do
  it "has form to create a new actor record", points: 1 do
    visit "/actors"

    expect(page).to have_tag("form", :count => 1),
      "Expect '/actors' page to have exactly one <form> tag, but couldn't find one. "
  end
end
...
describe "/actors" do
  it "has a form that creates a new actor record.", :points => 1 do
